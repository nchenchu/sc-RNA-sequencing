...
# Load Seurat object
seurat_obj <- readRDS("/Users/bigley/Library/CloudStorage/Box-Box/Bigley Lab/Navyasree Chenchu/Chenchu Projects/Chenchu MRV D0 R848/RDS files/MRV R848 scRNAseq cellcycle_corrected.rds")
...
b_vdj <- read.csv("/Users/bigley/Library/CloudStorage/Box-Box/Bigley Lab/Navyasree Chenchu/Chenchu Projects/Chenchu MRV D0 R848/vdj_b/filtered_contig_annotations.csv")
# head(t_vdj)
